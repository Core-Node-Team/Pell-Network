...
```
```
mkdir -p $HOME/.pellcored/cosmovisor/upgrades/v1.2.0/bin
sudo mv ./pellcored $HOME/.pellcored/cosmovisor/upgrades/v1.2.0/bin/pellcored
```
```
sudo ln -sfn $HOME/.pellcored/cosmovisor/upgrades/v1.2.0 $HOME/.pellcored/cosmovisor/current
